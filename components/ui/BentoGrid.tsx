...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("eka.ranggapwt@gmail.com");
    setcopied(true);
  };
  return (
    <div
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            {/* <div className="absolute z-50 flex text-white font-bold items-center justify-center"></div> */}
          </BackgroundGradientAnimation>
        )}
        <div
          className={cn(
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute top-0 -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-5">
                {["JavaScript", "Next.js", "Webflow"].map((item) => (
                  <span
                    key={item}
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-5">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]" />
                {["GSAP", "Three.Js", "MongoDB"].map((item) => (
                  <span
                    key={item}
                    className="lg:py-2 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#10132E]"
